...
# debug = yes / no
debug = no
# FORT = IUP-gfortran, HELIX-gfortran
FORT = HELIX-gfortran
############################
...
ifeq ($(FORT),IUP-gfortran)
	...
	LDFLAGS += -L$(zdir)lib -lz -ldl -lnsl

	FCDEP = $(FC) -cpp -M -ffree-line-length-none -fdefault-real-8 -fdefault-double-8 -J$(depdir) -I$(depdir) -I$(hdfdir)/include -I$(nc-fortrandir)/include -I$(nc-cdir)/include
else ifeq ($(FORT),HELIX-gfortran)
	FFLAGS = -c -J$(moddir) -I$(moddir)
	...
	FCDEP = $(FC) -cpp -M -ffree-line-length-none -fdefault-real-8 -fdefault-double-8 -fallow-invalid-boz -fallow-argument-mismatch -J$(depdir) -I$(depdir) -I$(hdfdir)/include -I$(nc-fortrandir)/include -I$(nc-cdir)/include
endif
